class Derrota extends Phaser.Scene {
    ...
    create(){
        ...
        if(plataforma == 1){
            ...
            if(language == 0){
                this.add.image(325, 325, "puntaje0").setScale(1.5);
            }
          
            if(language == 1){
                this.add.image(325, 325, "score0").setScale(1.5);
            }
          
            if(language == 2){
                this.add.image(325, 325, "ponto0").setScale(1.5);
            }
    
            restart = this.add.sprite(260, 450, "Restart").setScale(2).setInteractive()
            .on("pointerover", () => {
                restart2.setVisible(true);
            })
            .on("pointerout", () => {
            ...
            restart2 = this.add.sprite(260, 450, "Restart2").setScale(2).setVisible(false);
    
            menuButton = this.add.sprite(410, 450, "Menu").setScale(2.4).setInteractive()
            .on("pointerover", () => {
                menuButton2.setVisible(true);
            })
            .on("pointerout", () => {
