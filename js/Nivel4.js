class Nivel4 extends Phaser.Scene{
    ...
    create(){
        ...
        fondoLVL = this.add.sprite(325,325, "Escena2N");

        this.anims.create({
            key: 'lvl4',
            frames: this.anims.generateFrameNumbers('Nivel4', { start: 0, end: 3 }),
            frameRate: 3,
            repeat: -1
        });

        fondoLVL.anims.play('lvl4', true);
