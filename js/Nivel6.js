class Nivel6 extends Phaser.Scene{
    constructor(){
        super("Nivel6");
    }
    ...
    create(){
        ...
        fondoLVL = this.add.sprite(325,325, "Escena3N");

        this.anims.create({
            key: 'lvl6',
            frames: this.anims.generateFrameNumbers('Nivel6', { start: 0, end: 3 }),
            frameRate: 3,
            repeat: -1
        });

        fondoLVL.anims.play('lvl6', true);
